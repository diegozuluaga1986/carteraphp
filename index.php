    ...
    <div id="subheader">
      <ul class="nav">
        ...
        <li><a href="#">Prestamos</a>
          <ul>
            <li><a href="prestamos/formulario_prestamo.php" target="principal">Crear prestamo</a></li>
        ...
        <li><a href="abonos/listado.php" target="_blank">Imprimir listado diario</a>
          <ul>
          </ul>
        </li>
      </ul>
...
?>
  ...
  <div class="pie">
    <p>Prestamas v2.0</p><br>
    <p>creado por: Miller Adrian Posada Rendon </p>
    <br>

...
<?php
  ...
  if($cartera!=""){
    echo "<h3>Prestamos anulados cartera ".$cartera."</h3>";
    echo "<br>";
    ...
    $consulta.=" and prestamos.cod_cartera=$cod_cart and prestamos.estado ='2'";
    $consulta.=" order by fecha_fin DESC;";
...
<tr class='primeralinea'>
  ...
  <td class='primeralinea'>ANULADO POR</td>
  ...
  <td class='primeralinea'>ACCION</td>
 </tr>	
<?php
 $sumatoria=0;
 $total_abo=0;
 ...
 do
  {
   ...
   echo"<td> $".$monto_p."</td>\n";//SALDO PENDIENTE
   echo"<td><a href='..//prestamos/formulario_reactivar.php?id=$p' class='btn btn-info'>Reactivar</a></td>\n";//

...
<?php
  ...
  {
    echo"<center>";  
      echo"<form name='Insertar' method='post' Action='editar_p2.php'>";
      echo"<table>";
      ...
      echo"<tr><td>Cartera</td><td><select name='cartera'>";
      echo"<option> </option>";            
      do{
      ...
      echo "<br><br>";
      echo "<a href='..//abonos/ingreso_abonoform.php?id=$npres' class='btn btn-primary'>Agregar abono</a>";
      echo "<br><br>";

...
<?php
  ...
  if ($cartera=="") {
    ...
    echo"<td class='td_fecha'>NUMERO PRESTAMO</td>";
    ...
    do
    {
     echo"<tr data='capa' class='hover'>";
     echo"<td class='td_fecha'> <input type='text' name='num_id[]' size='6' value=".$matriz['num_prestamo']." readonly></td>";

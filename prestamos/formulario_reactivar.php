...
<html>
  ...
  <body>  
  <br><br><br>
  <center><h3>Reactivar Prestamo</h3><br></center>
  <br><br>
 <?php
  $npres=$_GET['id'];
  	if(!(empty($npres)))
  	...
  	{
    	echo"<center>";  
	    echo"<form name='Insertar' method='post' Action='Reactivar_prestamo.php'>";
	    echo"<table>";
	    ...
	    echo"</table><br>";
	    echo"<input type='submit' class='btn btn-success' onclick='pregunta4()' value='Reactivar'>";
	    echo"</form>";
	    echo"</center>";  
    }
  mysql_close($conex);
